        ...
        >
          <div className="relative flex flex-1 flex-wrap gap-1">
            {selected.map((option) => {
              return (
                <Badge
                  key={option.value}
                  className={cn(
                    'data-[disabled]:bg-gray-3 data-[disabled]:text-gray-11 data-[disabled]:hover:bg-gray-3',
                    'data-[fixed]:bg-gray-3 data-[fixed]:text-gray-11 [fixed]:hover:bg-gray-3',
                    badgeClassName,
                  )}
            ...
            <CommandPrimitive.Input
              ...
              className={cn(
                'flex-1 bg-transparent outline-none placeholder:text-gray-9',
                {
