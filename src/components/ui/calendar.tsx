  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: 'flex',
        head_cell: 'text-gray-9 rounded-md w-8 font-normal text-[0.8rem]',
        ...
        day_today: 'bg-gray-4 text-gray-12',
        day_outside:
        ...
        day_range_middle: 'aria-selected:bg-gray-4 aria-selected:text-gray-12',
