...
export function Navbar() {
  return (
    <nav className="sticky top-0 z-10 p-4 pb-0">
      <div className="absolute inset-0 bg-gradient-to-b from-gray-1 from-[1rem]" />
      <div className="flex items-center justify-between rounded-xl border border-gray-11/15 bg-gray-3/60 py-3 px-4 backdrop-blur-xl">
